...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || 'inrl~43006P0Nz6cec71011aede0479c34997105b', //your ssid to run bot
    HEROKU: {
    ...
    BOT_INFO : process.env.BOT_INFO || "moncef is your daddy",
    ...
    SUDO : process.env.SUDO || "212674218600",
